/datum/job/senior_scientist
	...
	access = list(
		...
		access_petrov_analysis, access_petrov_plasma, access_petrov_toxins, access_petrov_chemistry, access_petrov_security,
...
/datum/job/scientist
	...
	access = list(
		...
		access_petrov_analysis, access_petrov_plasma, access_petrov_toxins, access_petrov_chemistry, access_torch_fax,
...
/datum/job/scientist_assistant
	...
	access = list(
		...
		access_mining_office, access_mining_station, access_xenobiology, access_guppy_helm,
		access_xenoarch, access_nanotrasen, access_solgov_crew, access_expedition_shuttle, access_guppy, access_hangar,
		access_petrov_analysis, access_petrov_plasma, access_petrov_toxins, access_petrov_chemistry,
