...
/datum/job/hop
	...
	access = list(
		...
		access_explorer, access_pathfinder, access_pilot, access_commissary, access_petrov, access_petrov_helm, access_petrov_analysis, access_petrov_plasma,
...
/datum/job/rd
	...
	access = list(
		...
		access_petrov_analysis, access_petrov_plasma, access_petrov_toxins, access_petrov_chemistry, access_petrov_rd,
