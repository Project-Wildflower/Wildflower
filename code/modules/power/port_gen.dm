...
/obj/machinery/power/port_gen/pacman
	...
	machine_desc = "A portable generator often used for backup power or running small spacecraft. Runs on solid plasma sheets; rated for 80 kW max safe output."
...
/obj/machinery/power/port_gen/pacman/explode()
	...
	var/datum/gas_mixture/environment = loc.return_air()
	if (environment)
		environment.adjust_gas_temp(GAS_PLASMA, plasma/10, operating_temperature + T0C)
