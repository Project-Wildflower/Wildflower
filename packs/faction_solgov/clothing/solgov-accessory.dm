/obj/item/clothing/accessory/solgov
	...
	icon = 'packs/faction_solgov/icons/obj/obj_accessories_solgov.dmi'
	accessory_icons = list(slot_w_uniform_str = 'packs/faction_solgov/icons/mob/onmob_accessories_solgov.dmi', slot_wear_suit_str = 'packs/faction_solgov/icons/mob/onmob_accessories_solgov.dmi')
...
/obj/item/clothing/accessory/armor/tag/solgov
	...
	icon_override = 'packs/faction_solgov/icons/obj/obj_accessories_solgov.dmi'
	icon = 'packs/faction_solgov/icons/obj/obj_accessories_solgov.dmi'
	accessory_icons = list(slot_w_uniform_str = 'packs/faction_solgov/icons/mob/onmob_accessories_solgov.dmi', slot_wear_suit_str = 'packs/faction_solgov/icons/mob/onmob_accessories_solgov.dmi')
	icon_state = "solflag"
