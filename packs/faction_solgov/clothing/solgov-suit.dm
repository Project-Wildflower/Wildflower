...
/obj/item/clothing/suit/space/void/engineering/alt/sol
	...
	item_icons = list(slot_wear_suit_str = 'packs/faction_solgov/icons/mob/onmob_suit_solgov.dmi')
	sprite_sheets = list(
		SPECIES_UNATHI = 'packs/faction_solgov/icons/mob/unathi/onmob_suit_solgov_unathi.dmi',
		SPECIES_SKRELL = 'packs/faction_solgov/icons/mob/skrell/onmob_suit_solgov_skrell.dmi',
		)
	sprite_sheets_obj = list(
		SPECIES_UNATHI = 'packs/faction_solgov/icons/obj/unathi/obj_suit_solgov_unathi.dmi',
		SPECIES_SKRELL = 'packs/faction_solgov/icons/obj/skrell/obj_suit_solgov_skrell.dmi',
		)
